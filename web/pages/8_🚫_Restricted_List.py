...
from web.styles import inject_global_css, page_header, section_title, top_nav, material, DANGER, NEUTRAL
...
section_title("Restricted Tickers", badge_text=f"{len(restricted)} blocked", badge_color=DANGER)
...
section_title("Pipeline Skip", badge_text=f"{len(skip)} tickers", badge_color=NEUTRAL)
st.caption(
